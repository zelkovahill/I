...
public class GetImageAlternative : MonoBehaviour
{
    ...
    private IBarcodeReader render = new BarcodeReader();
    ...
    private void Update()
    {
        ...
        var result = render.Decode(cameraImageTexture.GetPixels32(), cameraImageTexture.width, cameraImageTexture.height);
